 ...
 *
 * @link https://www.webdesignleaves.com/pr/wp/wp_breadcrumbs.html
 */
 ...
 * ************************************************************************
 *
 * @link https://cotodama.co/wordpress_breadcrumb/
 */
function breadcrumb()
{
 ...
 * ************************************************************************
 *  パンくず生成関数
 *  @see https://wheelchair-coder.com/256/
 * ************************************************************************
 */
/*
function the_breadcrumbs()
{
  ...
  $term     = get_the_terms($post, $taxonomy[0]); // TODO：ここでエラーが出たので一旦、コメントアウト
  // 変数に格納
  $results .=
    '
